...
RAWOFDM_API raw_conv_enc_sptr raw_make_conv_enc ();
...
{
  friend RAWOFDM_API raw_conv_enc_sptr raw_make_conv_enc ();
...
{
  friend RAWOFDM_API raw_conv_dec_sptr raw_make_conv_dec (int length);
 ...
 public:
  void RAWOFDM_API set_length(int length);
...
RAWOFDM_API raw_conv_punc_sptr
...
{
  friend RAWOFDM_API raw_conv_punc_sptr raw_make_conv_punc (int nc, int np, unsigned char zero);
