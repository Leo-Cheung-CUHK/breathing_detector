...
RAWOFDM_API raw_intrlv_bit_sptr
...
{
  friend RAWOFDM_API raw_intrlv_bit_sptr raw_make_intrlv_bit (int ncarriers, int nbits, bool inverse);
...
RAWOFDM_API raw_intrlv_byte_sptr
...
{
  friend RAWOFDM_API raw_intrlv_byte_sptr raw_make_intrlv_byte (int nrows, int slope, bool inverse);
