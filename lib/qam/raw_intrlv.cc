...
raw_intrlv_bit::raw_intrlv_bit (int ncarriers, int nbits, bool inverse)
  : gr::sync_block (inverse ? "intrlv_bit_dec" : "intrlv_bit_enc",
            ...
            gr_vector_void_star &output_items)
{
  ...
  //std::cerr << " noutput = " << noutput_items << " map = " << d_map.size() << std::endl;
...
raw_intrlv_byte::raw_intrlv_byte (int nrows, int slope, bool inverse)
  : gr::sync_block (inverse ? "intrlv_byte_dec" : "intrlv_byte_enc",
                  gr::io_signature::make (1, 1, nrows*slope*sizeof(char)),
                  gr::io_signature::make (1, 1, nrows*slope*sizeof(char))),
