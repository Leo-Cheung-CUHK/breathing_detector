...
#ifndef INCLUDED_RAW_OFDM_INSERT_PREAMBLE_H
#define INCLUDED_RAW_OFDM_INSERT_PREAMBLE_H

#include <gnuradio/digital/api.h>
#include <gnuradio/block.h>
#include <vector>

class raw_ofdm_insert_preamble;
typedef boost::shared_ptr<raw_ofdm_insert_preamble> raw_ofdm_insert_preamble_sptr;

DIGITAL_API raw_ofdm_insert_preamble_sptr
...
class DIGITAL_API raw_ofdm_insert_preamble : public gr::block
{
  friend DIGITAL_API raw_ofdm_insert_preamble_sptr
  raw_make_ofdm_insert_preamble(int fft_length,
				    const std::vector<std::vector<gr_complex> > &preamble);

protected:
  raw_ofdm_insert_preamble(int fft_length,
			       const std::vector<std::vector<gr_complex> > &preamble);
...
#endif /* INCLUDED_RAW_OFDM_INSERT_PREAMBLE_H */
